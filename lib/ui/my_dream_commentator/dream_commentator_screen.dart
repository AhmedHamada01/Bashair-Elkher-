              ...
              Padding(
                ...
                child: Column(
                  children: [
                    InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>DreamsCommentatorFinished()));
                      },
                      child: Container(
                    ...
                    InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>DreamsCommentatorInProgress()));
                      },
                      child: Container(
                        padding: EdgeInsets.only(top: 15.0).r,
                        width: double.infinity,
